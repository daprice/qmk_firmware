...
qk_tap_dance_action_t tap_dance_actions[] = {
	//tap once for tilde, twice for caps lock
	[TD_TILDE_CAPS] = ACTION_TAP_DANCE_DOUBLE(KC_GRV, KC_CAPSLOCK)
};
...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        TD(TD_TILDE_CAPS),KC_BSLS,      KC_LCTL,  KC_LALT,KC_LGUI,
                                              KC_LCTL,  KC_LALT,
                                                              KC_HOME,
        ...
        // right hand
            ...
            MO(UTIL),     KC_N,   KC_M,   KC_COMM,KC_DOT, KC_SLSH,           KC_RSFT,
                         RGUI_T(KC_LEFT), RALT_T(KC_DOWN),RCTL_T(KC_UP),KC_RGHT,LT(MEDI, KC_MUTE),
             KC_RALT,        KC_RCTL,
             KC_PGUP,
 ...
 *
 * ,--------------------------------------------------.           ,--------------------------------------------------.
 * | TEENSY |  F1  |  F2  |  F3  |  F4  |  F5  |      |           | GAME |  F6  |  F7  |  F8  |  F9  |  F10 |        |
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 * |        |      |      |      |      |      |      |           |   (  |      |      |      | F11  |  F12 |   )    |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
...
[NUMP] = KEYMAP(
       ...
       KC_TRNS, KC_TRNS, KC_P1,     KC_P2,      KC_P3,      KC_PENT,  KC_TAB,
                         KC_P0,     KC_P0,      KC_PDOT,    KC_PENT,  KC_TAB,
       KC_TRNS, KC_TRNS,
       KC_TRNS,
       KC_TRNS, KC_TRNS, KC_TRNS
),
...
[GAME] = KEYMAP(
      // left hand
        ...
        KC_LSFT,        KC_Z,         KC_X,   KC_C,   KC_V,   KC_B,   MO(UTIL),
        TD(TD_TILDE_CAPS),KC_BSLS,      KC_LCTL,  KC_LALT,KC_SPC,
                                              KC_LCTL,  KC_LALT,
                                                              KC_HOME,
                                               KC_BSPC,KC_DEL,KC_END,
        // right hand
             ...
             KC_LBRC,      KC_Y,   KC_U,   KC_I,   KC_O,   KC_P,             KC_RBRC,
                          KC_H,   KC_J,   KC_K,   KC_L,   KC_SCLN,           KC_QUOT,
            MO(UTIL),     KC_N,   KC_M,   KC_COMM,KC_DOT, KC_SLSH,           KC_RSFT,
                         KC_SPC, RALT(KC_DOWN),RCTL_T(KC_UP),KC_RGHT,LT(MEDI, KC_MUTE),
             KC_RALT,        KC_RCTL,
             KC_PGUP,
             KC_PGDN,KC_ENT, KC_SPC
),
